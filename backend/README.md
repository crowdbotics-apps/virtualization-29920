...
## Project Structure
    ...
    ├── virtualization_29920  # Django project configurations
...
1. Clone this repo and `cd virtualization_29920`
...
2. Clone this repo and `cd virtualization_29920`
